...
public class MainActivity extends Activity {
    ...
    private BluetoothGattCharacteristic mHTCharacteristic, mHTIntervalCharacter;
    ...
    public DeviceEntry DeviceListCheckAdd(ArrayList<DeviceEntry> bt_list, BluetoothDevice new_bt) {
        int i = 0;
